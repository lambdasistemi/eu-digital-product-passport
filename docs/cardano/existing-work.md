...
|-----------|---------|----------|
| [cardano-foundation/mpfs](https://github.com/cardano-foundation/mpfs) | HTTP service wrapping Merkle Patricia Tries on Cardano | 290+ commits, active |
| [cardano-foundation/cardano-mpfs-onchain](https://github.com/cardano-foundation/cardano-mpfs-onchain) | Aiken on-chain validators for MPT proof verification | 34 commits, active (March 2026) |
| [cardano-foundation/cardano-mpfs-cage](https://github.com/cardano-foundation/cardano-mpfs-cage) | Language-agnostic cage validator spec with cross-language test vectors | Active (March 2026) |
