...
Article 14(2) requires manufacturers to provide **read-only BMS access** via the on-board diagnostics port or another interface, on a non-discriminatory basis. This means the user has a legal right to read BMS data.
