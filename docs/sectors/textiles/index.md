...
**Regulation**: ESPR delegated act — expected ~2025-2026.

**Deadline**: Compliance ~2027-2028 (18-24 months after delegated act).

**Granularity**: Likely batch or model level. Individual t-shirts do not have unique serials.
...
| **ESPR Art. 23** | Ban on destruction of unsold textiles (large enterprises from July 2026) | In force |
| **Textile Labelling Regulation (EU) 1007/2011** | Fibre composition labels | In force |
| **EU Strategy for Sustainable and Circular Textiles** (March 2022) | Policy framework for textile DPP | Communication |
| **EUDR** | Deforestation-free sourcing (cotton?) | Delayed |
